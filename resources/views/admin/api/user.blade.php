 ...
 <div class="page-content browse container-fluid">
        ...
        <div class="panel panel-bordered">
            <div class="panel-body">
                ...
                <div class="container">
                  <div class="col-sm-8 col-sm-offset-2" style="border: 1px solid #ef0909;padding: 25px;">
                ...
                <div class="form-group has-success has-feedback">
                  <label class="col-sm-4 control-label">Tổng tiền nạp vào:</label>
                  <div class="col-sm-4" style="margin-top: 7px;">
                    <!-- <input type="text" class="form-control" id="inputSuccess"> -->
                   <span style="font-weight: bold"> {{App\MrData::toPicePrivate($price)}}</span>
                  </div>
                </div>
                <div class="form-group has-warning has-feedback">
                  <label class="col-sm-4 control-label">Số request:</label>
                  <div class="col-sm-4" style="margin-top: 7px;">
                ...
                <div class="form-group has-primary has-feedback">
                  ...
                  <div class="col-sm-4" style="margin-top: 7px;">
                    <span style="font-weight: bold"> 
                      @if($balance > 0)
                      {{App\MrData::toPicePrivate($balance)}}
                      @else
                      {{App\MrData::toPicePrivate($price)}}
                      @endif
                    </span>
                  </div>
                </div>
                <div class="form-group has-danger has-feedback">
                  <label class="col-sm-4 control-label">Nạp tiền:</label>
                  <div class="col-sm-4">
                    <button type="button" id="removemulti" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalRemove" >Nạp Tiền</button>
                  </div>
                </div>
              </div>
    ...
    <div class="modal fade" id="exampleModalRemove" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="form-inline" action="{{url('admin/trash/removemulti')}}" method="POST">
          @csrf
        <div class="modal-content">
                  ...
                  <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 text-center" style="margin-top: 20px; margin-bottom: 20px;">
                            <h4 style="    text-transform: uppercase;">Thông tin cần nhập</h4>
                        </div>
          ...
          <div class="modal-footer text-center">
            ...
            <button type="submit" class="btn btn-primary removemulti ">Nạp</button>
          </div>
        </div>
        </form>
      </div>
    ...
    <div class="page-content">
         ...
         @if($role_id == 10 || $role_id == 4 || $role_id == 7 || $role_id == 8 || $role_id == 9)
