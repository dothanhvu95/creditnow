            ...
            <div class="col-sm-12 text-center">
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <h3 style="font-weight: bold;">Đối soát Access Trade</h3>
                    </div>
                </div>
                <?php 
				...
				{!! Form::open(['method'=>'get','class'=>"form-inline"]) !!}
                     <div class="col-sm-12 text-left">
                        ...
                        ?>
                        <a href="/backend/admin/accesstrade-export{{$u}}" class="btn btn-success"> Export Report</a>  
                    </div>
                {!! Form::close()!!}
                    ...
                    <table id="customers" class="table table-hover">
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td colspan="" rowspan="" headers=""><span class="label label-info" style="font-weight: bold;">Access Trade</span></td>
                                <td colspan="" rowspan="" headers=""><span style="font-weight: bold;">{{$value->total}}</span></td>
                                <td colspan="" rowspan="" headers=""><span style="font-weight: bold;">{{$value->hscd}}</span></td>
                               ...
                               <td>
                                <?php
                                    ...
                                    ?>
                                   <a href="/backend/admin/history?from_date_tn={{$from_date}}&to_date_tn={{$to_date}}&agence=245" type="submit" class="btn btn-sm btn-primary pull-center edit" target="_blank"><i class="voyager-eye"></i><span class="hidden-xs hidden-sm"> Xem chi tiết</span></a>
                               </td>
                            </tr>
							@endforeach
