            ...
            <div class="col-sm-12 text-center">
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <h3 style="font-weight: bold;">Đối soát Partner ADPIA</h3>
                    </div>
                </div>
                <?php 
				...
				{!! Form::open(['method'=>'get','class'=>"form-inline"]) !!}
                     <div class="col-sm-12 text-left">
                        ...
                        ?>
                        <a href="/backend/admin/adpia-export{{$u}}" class="btn btn-success"> Export Report</a>    
                    ...
                    <table id="customers" class="table table-hover">
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td colspan="" rowspan="" headers=""><span class="label label-info" style="font-weight: bold;">Partner ADPIA</span></td>
                               ...
                               <td>
                                <?php
                                    ...
                                    ?>
                                   <a href="/backend/admin/history?from_date_tn={{$from_date}}&to_date_tn={{$to_date}}&agence=98" type="submit" class="btn btn-sm btn-primary pull-center edit" target="_blank"><i class="voyager-eye"></i><span class="hidden-xs hidden-sm"> Xem chi tiết</span></a>
                               </td>
                            </tr>
							@endforeach
